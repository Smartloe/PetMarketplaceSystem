...
class UserInfo(models.Model):
	...
	user_status = models.SmallIntegerField(default=1, verbose_name='用户状态', choices=status_choices, )
...
class Admin(models.Model):
	...
	is_active = models.SmallIntegerField(choices=status_choices, verbose_name='管理员状态', default=1)
	created_by = models.CharField(max_length=32, verbose_name='创建人')
	created_time = models.DateTimeField(auto_now_add=True, verbose_name='创建时间')
	last_login_time = models.DateTimeField(verbose_name='最后登录时间', null=True, blank=True)
